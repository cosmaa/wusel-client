<template>
  <sunburst :data="tree">
    ...
    <!-- Add bottom legend -->
    <breadcrumbTrail slot="legend" slot-scope="{ nodes, colorGetter, width }" :current="nodes.mouseOver" :root="nodes.root" :color-getter="colorGetter"
:from="nodes.clicked" :width="width" />
  </sunburst>
</template>
<script>
